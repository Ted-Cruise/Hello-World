...
public:
    ...
    Quaternion(double ix, double iy, double iz)
    {
        Quaternion(0, ix, iy, iz);
    }
    ...
    // Converts to axis angle and returns angle
    float toAxisAngle() const
    {
        return 2 * acos(_w);
    }
    ...
    // 500B
    Quaternion rotationBetweenVectors(Quaternion& q) const 
    {
